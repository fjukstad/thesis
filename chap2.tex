...
The Pippeline application builds upon the \gls{nowac} R package and its design
choices. It is targeted towards researchers who want to analyze different
datasets frmo the \gls{nowac} cohort. Figure \ref{fig:scr_filtering}
shows a screenshot of the web application.

\begin{figure}
  \includegraphics[width=\linewidth]{figures/scr_filtering.png}
  \caption{Web-interface of UiT pippeline.}
