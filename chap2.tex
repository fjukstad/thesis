...
ago.\cite{gentleman2007statistical}
There are many examples of studies that put in significant efforts to develop
tools in R for transparent data science, to produce better science in less
...
simplify the analysis. Many of these packages are open-sourced for everyone to
use, and we hope to do the same. 
