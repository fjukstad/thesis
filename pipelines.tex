...
With \texttt{walrus} we target pipeline developers that are familiar with
...
across systems. Further, \texttt{walrus} allows researchers to track 
input, intermediate, and resulting datasets to help ensure reproducible results. 
...
% Portability: move pipeline between dev comp, azure, hunt, stallo...
