...
\textbf{Commonalities}. 
Both approach to build analysis pipelines and to write interactive data
...
into a software container which are then orchestrated together. These containers
...
In this section we detail the different systems we have developed using the
approach. 
