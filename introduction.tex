...
interpret the results.\cite{mardis20101} Since the inferences are only as good
as the information they are based on, there is a need to ensure the quality of
the underlying data and the analysis pipelines
used.\cite{international2018biocuration}
